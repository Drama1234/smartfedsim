...
public class GeneticAllocator1 extends AbstractAllocator{
	...
	public GeneticAllocator1()
	{
		super();
	}
	
	public GeneticAllocator1(MonitoringHub monitoring, InternetEstimator netEstimator) {
		super();
